...
describe('total likes', () => {
  ...
  test('when list has only multiple blogs, equals the likes of that', () => {
    const result = listHelper.totalLikes(testMultipleBlogs);
...
describe('favorite blog', () => {
  ...
  test('when list has multiple blog, equals the most liked one', () => {
    const result = listHelper.favoriteBlog(testMultipleBlogs);
...
describe('most blogs', () => {
  ...
  test('when list has only one blog, returns the details of the single author', () => {
  ...
  test('when list has multiple blog, equals the most liked one', () => {
    const result = listHelper.mostBlogs(testMultipleBlogs);
    expect(result).toEqual({
      author: 'Robert C. Martin',
      blogs: 3,
    });
...
describe('most liked', () => {
  ...
  test('when list has multiple blog, equals the most liked one', () => {
    const result = listHelper.mostLikes(testMultipleBlogs);
    expect(result).toEqual({
      author: 'Edsger W. Dijkstra',
      likes: 17,
    });
